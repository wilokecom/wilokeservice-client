...
class UpdateController
{
    ...
    public function __construct()
    {
        ...
        add_action('wilokeservice-clients/theme-updates', [$this, 'showUpTheme']);
    ...
    private function buildUpdatePluginSkeleton($aPlugin)
    {
        return (object)[
            ...
            'url'          => isset($aPlugin['changelog']) && !empty($aPlugin['changelog']) ? $aPlugin['changelog'] :
                wilokeServiceGetConfigFile('app')['defaultChangeLogUrl'],
        ...
        switch ($this->responseCode) {
            ...
            case 'PurchasedCodeExpired':
                ...
                <div class="ui message negative">
                    ...
                    <a href="<?php echo esc_url(wilokeServiceGetConfigFile('app')['renewSupportURL']); ?>"
            ...
            case 'INVALID_TOKEN':
                ...
                <div class="ui message negative">
                    Invalid Token. Please log into <a
                        href="<?php echo esc_url(wilokeServiceGetConfigFile('app')['serviceURL']); ?>"
    ...
    public function showUpTheme()
    {
        ...
        <div id="wilokeservice-update-theme" class="ui segment" style="margin-top: 30px;">
            <h3 class="ui heading"><?php echo $this->getCurrentTheme()->get('Name'); ?></h3>
                    ...
                    <div class="wil-theme-item-wrapper card" style="width: 300px;">
                        <div class="content" style="padding: 1.3em 1.2em;">
                            <img class="right floated mini ui image" style="width: 60px"
                                 src="<?php echo esc_url($this->aTheme['thumbnail']); ?>">
                            <div class="header"
                            ...
                            <div class="meta" style="font-size: 13px">
                                ...
                                <span class="version" style=" display: block; margin-bottom: 2px; color: #222">
                                    New Version: <span
                                        class="wil-new-version"><?php echo esc_html($this->aTheme['version']); ?></span>
                                </span>
                                <span class="updated_at"
                                      style=" display: block; color: #222">
                                    Updated at: <?php echo date_i18n(get_option('date_format'),
    ...
    public function showUpPlugins()
    {
        ...
        <div id="wilokeservice-update-plugins" class="ui segment">
            <h3 class="ui heading">Install / Update Plugins</h3>
            <div class="ui message wil-plugin-update-msg hidden"></div>
    ...
    {
        if (isset($_GET['page']) && $_GET['page'] === wilokeServiceGetConfigFile('app')['updateSlug']) {
            $this->afterSwitchTheme('');
        }
    }
